--[[
 * ReaScript Name: Add envelope points at time selection edges from center to max preserving edges
...
function main() -- local (i, j, item, take, track)
	...
	reaper.Undo_EndBlock("Add envelope points at time selection edges from center to max preserving edges", -1) -- End of the undo block. Leave it at the bottom of your main function.
