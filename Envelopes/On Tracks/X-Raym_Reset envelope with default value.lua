--[[
 * ReaScript Name: Reset envelope with default value
...
function Action(env)
	...
	if visible == true and armed == true then
		...
		reaper.BR_EnvSetPoint(br_env, 0, 0, centerValue, 0, false, 0)
...
function main() -- local (i, j, item, take, track)
	...
	reaper.Undo_EndBlock("Reset envelope with default value", -1) -- End of the undo block. Leave it at the bottom of your main function.
