 ...
 * About: Take previous (from cursor position) point value, and insert a new point with that value under the next point. Works on selected tracks, with visble and armed envelope.
