--[[
 * ReaScript Name: Copy envelope values at edit cursor and insert at time selection
...
function main() -- local (i, j, item, take, track)
	...
	if start_time ~= end_time then
		...
		reaper.Undo_EndBlock("Copy envelope values at edit cursor and insert at time selection", 0) -- End of the undo block. Leave it at the bottom of your main function.
