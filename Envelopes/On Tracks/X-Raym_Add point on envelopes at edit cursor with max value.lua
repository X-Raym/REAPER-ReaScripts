--[[
 * ReaScript Name: Add point on envelopes at edit cursor with max value
...
function AddPoints(env)
	...
	if visible == true and armed == true then
		...
		if cursor_point ~= -1 then
			...
			reaper.InsertEnvelopePoint(env, offset, maxValue, 0, 0, true, true) -- INSERT startLoop point
...
reaper.Undo_EndBlock("Add point on envelopes at edit cursor with max value", 0) -- End of the undo block. Leave it at the bottom of your main function.
