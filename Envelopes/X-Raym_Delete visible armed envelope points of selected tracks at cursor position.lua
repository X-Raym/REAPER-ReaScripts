--[[
 * ReaScript Name: Delete visible armed envelope points of selected tracks at cursor position
...
function main() -- local (i, j, item, take, track)
	...
	offset = reaper.GetCursorPosition()
		...
		reaper.Undo_EndBlock("Delete visible armed envelope points of selected tracks at cursor position", 0) -- End of the undo block. Leave it at the bottom of your main function.
