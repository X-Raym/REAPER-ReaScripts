--[[
 * ReaScript Name: Delete visible armed envelope points of selected tracks in time selection
...
function main() -- local (i, j, item, take, track)
	...
	startLoop, endLoop = reaper.GetSet_LoopTimeRange2(0, false, true, 0, 0, false)
		...
		reaper.Undo_EndBlock("Delete visible armed envelope points of selected tracks in time selection", 0) -- End of the undo block. Leave it at the bottom of your main function.
