--[[
 * ReaScript Name: Invert visible armed envelope points values for selected tracks in time selection preserving edges
...
function main() -- local (i, j, item, take, track)
	...
	reaper.Undo_EndBlock("Invert visible armed envelope points values for selected tracks in time selection preserving edges", 0) -- End of the undo block. Leave it at the bottom of your main function.
