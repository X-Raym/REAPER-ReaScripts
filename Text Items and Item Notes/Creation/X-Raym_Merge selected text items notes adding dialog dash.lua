 ...
 * About: Use this action on text items. It will merge them in one item only, from first item position to last one end, preserving all notes one under the other, and adding dialog dash in front of each notes. This works for each tracks.
