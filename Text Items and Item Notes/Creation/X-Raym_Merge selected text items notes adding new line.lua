--[[
 * ReaScript Name: Merge selected text items notes adding new line
...
-- Dependency Name
local script = "X-Raym_Merge selected text items notes.lua" -- 1. The target script path relative to this file. If no folder, then it means preset file is right to the target script.
