--[[
 * ReaScript Name: Add underline markup to selected items notes
 * Description: Add underline markup to selected items notes
...
function underline() -- local (i, j, item, take, track)
	...
	reaper.Undo_EndBlock("Add underline markup to selected items notes", 0) -- End of the undo block. Leave it at the bottom of your main function.
...
underline() -- Execute your main function
