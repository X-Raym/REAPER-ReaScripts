--[[
 * ReaScript Name: Add text at end of selected items notes
 * Description: Add text at end of selected items notes
...
function main(input) -- local (i, j, item, take, track)
	...
	reaper.Undo_EndBlock("Add text at end of selected items notes", -1) -- End of the undo block. Leave it at the bottom of your main function.
...
retval, user_input_str = reaper.GetUserInputs("Add text at end", 1, "Text: ", "") -- We suppose that the user know the scale he want
if retval == true then
