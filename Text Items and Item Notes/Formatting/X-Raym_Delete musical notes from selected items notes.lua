--[[
 * ReaScript Name: Delete musical notes from selected items notes
 * Description: Delete musical notes from selected items notes
...
function delete_background() -- local (i, j, item, take, track)
	...
	reaper.Undo_EndBlock("Delete musical notes from selected items notes", 0) -- End of the undo block. Leave it at the bottom of your main function.
