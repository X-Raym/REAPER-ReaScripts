--[[
 * ReaScript Name: Delete break line markup from selected items notes
 * Description: Delete break line markup from selected items notes
...
function delete_background() -- local (i, j, item, take, track)
	...
	reaper.Undo_EndBlock("Delete break line markup from selected items notes", 0) -- End of the undo block. Leave it at the bottom of your main function.
