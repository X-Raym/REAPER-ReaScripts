--[[
 * ReaScript Name: Swap selected item notes and take name preserving break lines
 * Description: Swap selected item notes and take name preserving break lines
...
function swap() -- local (i, j, item, take, track)
	...
	reaper.Undo_EndBlock("Swap selected item notes and take name preserving break lines", 0) -- End of the undo block. Leave it at the bottom of your main function.
