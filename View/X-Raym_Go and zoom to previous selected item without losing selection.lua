...
if count_sel_items > 0 then
	...
	reaper.Undo_EndBlock("Go and zoom to previous selected item without losing selection", -1) -- End of the undo block. Leave it at the bottom of your main function.
