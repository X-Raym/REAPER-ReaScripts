--[[
 * ReaScript Name: Move selected items position right according to their snap offset
 * Description: Useful if an action use snap offset for snapping but you prefer item position.
