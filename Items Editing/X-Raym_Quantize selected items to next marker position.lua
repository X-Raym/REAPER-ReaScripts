--[[
 * ReaScript Name: Quantize selected items to next marker position
...
function NextValue(table, number)
...
if count_sel_items > 0 and count_markers > 0 then
  ...
  main()
  reaper.Undo_EndBlock("Quantize selected items to next marker position", -1)
