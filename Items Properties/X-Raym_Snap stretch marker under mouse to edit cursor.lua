...
-- based on X-Raym_Snap stretch marker under mouse to closest grid line.line
...
function main()
  ...
  reaper.Undo_EndBlock("Snap stretch marker under mouse to edit cursor", -1) -- End of the undo block. Leave it at the bottom of your main function.
