--[[
 * ReaScript Name: Set selected audio takes RMS average value by columns according to first track with selected items
...
function main() -- local (i, j, item, take, track)
	...
	reaper.Undo_EndBlock("Set selected audio takes RMS average value by columns according to first track with selected items", -1) -- End of the undo block. Leave it at the bottom of your main function.
