--[[
 * ReaScript Name: Search and replace in markers names
 * Author: X-Raym
...
input_title = "Search & Replace in markers Names"
undo_text = "Search and replace in markers names"
-----------------------------------------------------------
...
ext_name = "XR_SearchReplaceMarkerNames"
